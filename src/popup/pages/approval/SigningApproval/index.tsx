...
import { CelebrationGlow, GlassCard, PillButton, Icon, DismissibleError } from "../../../components/ui";
...
export function SigningApproval() {
  ...
  return (
    ...
    >
      ...
      <motion.div className="flex-1 flex flex-col gap-2 min-h-0" variants={fadeUp}>
        ...
        {hasInvisibleChars && (
          // Warning reads as a single decisive enter — slight scale +
          // amber ring — not a continuous pulse (research §2.6: no
          // marketing-style pulsing). After the entrance animation it
          // stays static; the visual weight alone is the alert.
          <motion.div
            ...
            transition={{
              ...tween.mediumOutStrong,
              boxShadow: { duration: 1.1, ease: "easeOut" },
            }}
            className="p-3 bg-amber-50 border border-amber-200 rounded-xl text-[12px] text-amber-900 flex items-start gap-2"
          >
